...
import { Trophy, Medal, Award, ArrowRight, Trash2, Star, Edit2, Check, X } from "lucide-react";
                    ...
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        onBlur={(e) => {
                          ...
                          if (!isNaN(val) && val !== m.obtained) {
                            updateMark.mutate({ subjectId: m.subjectId, obtained: val });
                          }
                        }}
                      />
                      ) : (
                        <div className="w-20 h-9 flex items-center justify-center font-bold text-sm bg-muted/20 rounded border border-transparent text-primary">
                          {m.obtained}
                        </div>
                      )}
